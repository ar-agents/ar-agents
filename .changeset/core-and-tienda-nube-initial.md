...
Two new packages: shared middleware primitives + Tienda Nube.
...
The #2 e-commerce platform in Argentina (100k+ merchants). No competitor SDK ships agent-native ergonomics, so this is uncontested.
