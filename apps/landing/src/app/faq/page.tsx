...
const FAQS: Q[] = [
  ...
  },
  {
    ...
    a: '39 packages npm publicados con SLSA v1 provenance, 245 tools, 15 endpoints HTTP hosted (<code>/api/auto-incorporate</code>, <code>/api/registry/*</code>, <code>/api/certifier</code>, <code>/api/play/*</code>, <code>/api/badge/{sessionId}</code>, <code>/api/auditor/*</code>, listado completo en <a href="/reference">/reference</a>), 1 SDK (<code>@ar-agents/incorporate</code>), 1 CLI (<code>@ar-agents/cli</code>), 30 cookbook recipes, 618 unit tests en la landing. Todo verificable en <a href="/api/discovery">/api/discovery</a> (machine-readable JSON o OpenAPI 3.1).',
  },
