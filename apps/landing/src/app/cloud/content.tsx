...
const TIERS: ReadonlyArray<Tier> = [
  {
    ...
    status: "available",
    features: [
      { es: "33 packages npm bajo @ar-agents/*", en: "33 npm packages under @ar-agents/*" },
        ...
        >
          ...
          <tbody>
            {[
              ...
              ["ar-agents", { es: "33 npm packages, 6 RFCs, reference impl", en: "33 npm packages, 6 RFCs, reference impl" }, { es: "Studio · Government · Bespoke (esta página)", en: "Studio · Government · Bespoke (this page)" }],
            ].map((row, i) => {
