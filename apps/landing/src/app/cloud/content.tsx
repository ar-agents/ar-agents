...
const TIERS: ReadonlyArray<Tier> = [
  {
    ...
    status: "available",
    features: [
      { es: "36 packages npm bajo @ar-agents/*", en: "36 npm packages under @ar-agents/*" },
        ...
        >
          ...
          <tbody>
            {[
              ...
              ["ar-agents", { es: "36 npm packages, 6 RFCs, reference impl", en: "36 npm packages, 6 RFCs, reference impl" }, { es: "Studio · Government · Bespoke (esta página)", en: "Studio · Government · Bespoke (this page)" }],
            ].map((row, i) => {
