...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://ar-agents.vercel.app/rfcs/002" },
};

export default function Rfc002Page() {
  return (
    <DocShell
      eyebrow="/arg · rfc-002 · draft · 2026-05"
      title="RFC-002: Agent-Discovery-By-Default."
...
/api/discovery?format=openapi  — same inventory as OpenAPI 3.1`}
  ...
  "totalTools": <int>
      ...
      <DocP>
        ar-agents.vercel.app implements all four endpoints. Spec
        compliance check:
      </DocP>
      <ul style={listStyle}>
        <Li>
          <a
            href="https://ar-agents.vercel.app/.well-known/agents.json"
            style={{ color: "var(--accent)" }}
          >
        ...
        <Li>
          <a
            href="https://ar-agents.vercel.app/.well-known/ai-plugin.json"
            style={{ color: "var(--accent)" }}
          >
        ...
        <Li>
          <a
            href="https://ar-agents.vercel.app/api/discovery"
            style={{ color: "var(--accent)" }}
          >
            /api/discovery
          </a>{" "}
        ...
        <Li>
          <a
            href="https://ar-agents.vercel.app/api/discovery?format=openapi"
            style={{ color: "var(--accent)" }}
          >
