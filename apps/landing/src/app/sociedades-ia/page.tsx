...
export const metadata: Metadata = {
  ...
  description:
    "Implementación de referencia de sociedades de IA en Argentina. Cómo una empresa 100% IA se incorpora, factura, paga monotributo, atiende clientes, usando ar-agents.",
  alternates: {
