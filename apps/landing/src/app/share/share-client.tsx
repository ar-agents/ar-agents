...
const SNIPPETS: ReadonlyArray<Snippet> = [
  {
    ...
    body: `Argentina anunció sociedades automatizadas el 28-abr. Publiqué 6 RFCs + infraestructura open-source que la ley puede citar:
...
Todo MIT + CC-BY-4.0. ar-agents.ar`,
  ...
  },
  {
    ...
    body: `Cualquiera puede verificar la conformidad de una sociedad automatizada argentina en 10 segundos, sin install.
...
La impl de referencia pasa los 7 (96 tests).`,
  ...
  },
  {
    ...
    body: `Hace un mes el ministro Sturzenegger anunció un régimen de sociedades automatizadas en Argentina.

Decidí no esperar a que se publique el texto del proyecto de ley. La infraestructura técnica para que las sociedades automatizadas funcionen ya existe, había que escribirla.
...
→ Descubrimiento (RFC-002): cada sociedad automatizada publica su info en /.well-known/agents.json. Sin registro central, sin permiso.
...
Para regulators / journalists: ar-agents.ar/auditor`,
  ...
  },
  {
    ...
    body: `Asunto: Infraestructura técnica para sociedades automatizadas, RFCs publicados + listos para citar
...
Después del anuncio del Min. Sturzenegger del 28-abr-2026, dediqué el mes a publicar la infraestructura técnica que un régimen de sociedades automatizadas necesita para ser operativizable. El resultado:
...
Monte Grande, BA`,
  ...
  },
  {
    ...
    body: `Subject: Argentina's proposed automated-company regime, published open-source infrastructure

Dear [Journalist Name],

I'm writing because you covered [recent piece by them, paste link here].

Argentina announced an "automated company" (sociedad automatizada) regime on April 28, 2026. I'm not a government employee; I'm a Buenos Aires-based engineer who decided not to wait for the law text and instead published the technical infrastructure such a regime would need.

The result is six RFCs + an open-source reference implementation at ar-agents.ar:

1. RFC-001, Three-layer civil-liability framework (operator / automated company / model provider).
...
4. RFC-004, Normative wire format for the operational log every automated company must keep. 7 frozen conformance vectors with hex-exact HMAC values.
...
naza@naza.ar`,
  ...
  },
  {
    ...
    body: `Asunto: Especificación abierta del log operativo para sociedades automatizadas, implicancias en Ley 25.326

Estimado/a [nombre],

Le escribo en relación con el anuncio del régimen de sociedades automatizadas del 28-abr-2026 y su intersección con la Ley 25.326 de protección de datos personales.

Publiqué una especificación normativa abierta del log operativo que toda sociedad automatizada debería mantener (RFC-004, ar-agents.ar/rfcs/004). El documento toma posiciones explícitas sobre:
