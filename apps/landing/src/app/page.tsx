const PACKAGES = [
  ...
  },
  {
    ...
    version: "0.4.0",
    purpose:
      "Full Mercado Pago agent toolkit: Payments + Checkout Pro + Subscriptions + Reusable Plans + Customers + Cards + Refunds + Cuotas + Saved-card charging + In-store QR + Stores/POS self-serve + Disputes + Webhooks management. 41 tools cover the entire agent-relevant MP API surface. Auto-retry, deterministic idempotency, observability hooks.",
    tools: [
