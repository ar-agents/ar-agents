    ...
    <>
      ...
      <JsonLd
        data={{
          ...
          name: "ar-agents",
          description:
            "Open-source toolkit and reference implementation for Argentine sociedades-IA. 33 npm packages, 221 tools, 5 hosted endpoints.",
          inLanguage: ["es-AR", "en"],
          potentialAction: {
            "@type": "SearchAction",
  ...
  return (
    <JsonLd
      data={{
        ...
        tool: [
          { "@type": "HowToTool", name: "@ar-agents/* npm packages (33 paquetes)" },
