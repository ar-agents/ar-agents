...
export const metadata: Metadata = {
  ...
  description:
    "Carta abierta al Ministro Federico Sturzenegger sobre la implementación técnica del régimen de sociedades-IA. Reference implementation MIT, 17 paquetes en npm, 168 herramientas, AAIF working-group propuesto. Listo para usar el día que la ley salga.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "17 paquetes npm, MIT, 168 herramientas, 16 de 17 piezas operativas cubiertas. Listo para el día que la ley salga.",
