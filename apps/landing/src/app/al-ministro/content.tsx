      ...
      >
        <li>
          <L
            ...
            es={
              <>
                <strong>36 paquetes</strong> en el scope{" "}
                <DocCode>@ar-agents/*</DocCode> en npm.
              </>
            }
            en={
              <>
                <strong>36 packages</strong> under the{" "}
        ...
        <li>
          <L
            ...
            es={
              <>
                <strong>235 herramientas</strong> con definiciones de
            ...
            en={
              <>
                <strong>235 tools</strong> with verified type
