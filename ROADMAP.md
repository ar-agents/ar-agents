...
- status: ready (M1-4a done 2026-07-11, PR #PRNUM; the CLI package, account bootstrap, and config now exist)
- priority: P2
...
- status: ready (M1-4a done 2026-07-11, PR #PRNUM; the CLI package and account/config surface now exist)
- priority: P2
