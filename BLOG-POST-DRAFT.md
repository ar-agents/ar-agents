...
Front matter for dev.to (https://dev.to/new):
  title: "I shipped 36 npm packages for Argentina's AI-corporation law (starting with Mercado Pago's 89 tools)"
  published: false
