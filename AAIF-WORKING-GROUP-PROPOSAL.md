...
- **`@ar-agents/*` on npm** — 11 packages covering 16/17 pieces (MIT, npm provenance, AGENTS.md per package). Reference implementation. github.com/ar-agents/ar-agents
